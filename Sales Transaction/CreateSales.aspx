<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSales.aspx.cs" Inherits="Unipro_Store.Sales_Transaction.CreateSales" %>
                    ...
                    <asp:Repeater ID="rptProducts" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDisc" runat="server" CssClass="form-control discount-input" TextMode="Number" Min="0" Max="100" Step="0.01" style="width: 65px;"/>
                                </td>
