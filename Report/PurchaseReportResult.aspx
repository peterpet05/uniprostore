<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PurchaseReportResult.aspx.cs" Inherits="Unipro_Store.Report.PurchaseReportResult" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row" style="margin-top: -15px">
        <div class="col-sm-12">
            ...
            <!-- Tabel Hasil Laporan Pembelian -->
            <div class="card-body table-responsive p-0" style="height: 420px;">
                <table class="table table-bordered table-striped table-head-fixed text-nowrap" id="tabelPurchaseReportResult">
                    <thead>
                        <tr>
                            <th>Tanggal</th>
                    ...
                    <tbody>
                        <asp:Repeater ID="rptPurchaseReport" runat="server">
                            <ItemTemplate>
                                <tr>
            ...
            <!-- Penutup Tabel Hasil Laporan Pembelian -->
        ...
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("downloadPdf").addEventListener("click", function (event) {
                ...
                getBase64ImageFromURL('/Admin LTE/dist/img/Head.png', function (headerBase64) {
                    ...
                    doc.setFontSize(15); 
                    doc.text('LAPORAN PEMBELIAN PRODUK', 148.5, 54, { align: 'center' });

                    doc.setFont('helvetica', 'normal');
                    doc.setFontSize(10); 
                    doc.text(`Periode ${startDate} s/d ${endDate}`, 148.5, 61, { align: 'center' });

                    var table = document.getElementById('tabelPurchaseReportResult');
                    var totalHarga = 0;
                    ...
                    doc.autoTable({
                        html: '#tabelPurchaseReportResult',
                        startY: 70, 
                        theme: 'striped', 
                        headStyles: {
                            fillColor: [3, 14, 46], 
                    ...
                    doc.text('Total pembayaran seluruh produk dibeli: ' + formattedTotalHarga, 148.5, finalY + 11, { align: 'center' }); // Teks di tengah

                    doc.save('LaporanPembelian.pdf');
                });
            });
        });
        ...
        document.getElementById("downloadExcel").addEventListener("click", function (event) {
            ...
            XlsxPopulate.fromBlankAsync()
                .then(workbook => {
                    ...
                    sheet.cell("A2").value("Laporan Pembelian Produk").style({
                        fontSize: 14,
                        horizontalAlignment: 'center',
                        verticalAlignment: 'center',
                        fontColor: "FFFFFF", 
                    ...
                    const headers = ['Tanggal', 'Kode Transaksi', 'Supplier', 'Nama Produk', 'Kuantitas', 'Total Harga'];
                    ...
                    sheet.column("C").width(30); // Supplier
                ...
                .then(function (blob) {
                    ...
                    a.href = url;
                    a.download = "LaporanPembelian.xlsx";
