<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSubcategory.aspx.cs" Inherits="Unipro_Store.Subcategory.CreateSubcategory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card card-info">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="inputCategory" runat="server" required>
    ...
    <!-- Menghapus border merah saat mulai mengetikkan nama subkategori baru -->
    <script>
