<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Purchase.aspx.cs" Inherits="Unipro_Store.Purchase_Transaction.Purchase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-md-12">
            <div>
                <div class="row mb-3 align-items-center">
                    <div class="col-md-9 d-flex align-items-center">
                        <div class="input-group">
                            <input type="search" id="searchKeyword" class="form-control search-with-icon" placeholder="Search keyword" aria-controls="tabelPurchaseTransaction">
                        </div>
                    </div>
                    <div class="col-md-3 d-flex align-items-center">
                        <label for="filterSupplier" style="margin-right: 10px; margin-top: 6px"">Supplier:</label>
                        <select id="filterSupplier" class="form-control" runat="server">
                        </select>
                    </div>
                </div>
                <!-- Tabel Purchase Transaction -->
                <table id="tabelPurchaseTransaction" class="table table-bordered table-striped" style="width: 100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kode</th>
                ...
                <!-- Penutup Tabel Purchase Transaction-->
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="border-radius: 20px; padding: 20px;">
                            ...
                            <div class="modal-body" style="padding-top: 0px;">
                                ...
                                <asp:HiddenField ID="hfPurchaseTransactionIDToDelete" runat="server" />
                            </div>
    ...
    <script>
        $(document).ready(function () {
            var table = $('#tabelPurchaseTransaction').DataTable({
                "responsive": true,
                "lengthChange": false,
                "autoWidth": false,
                "dom": 'rt' +
            ...
            $('select[id$=filterSupplier]').on('change', function () {
                var selectedSupplier = this.value;
                if (selectedSupplier) {
                    table.column(3).search(selectedSupplier).draw();
                } else {
    ...
    <!-- Modal Delete Purchase Transaction -->
    <script>
        function showDeleteModal(purchaseId) {
            $('#<%= hfPurchaseTransactionIDToDelete.ClientID %>').val(purchaseId);
