<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateVariation.aspx.cs" Inherits="Unipro_Store.Product.CreateVariation" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-sm-12" style="padding-left: 0px">
        <asp:LinkButton runat="server" ID="AddColor" CssClass="btn" OnClick="AddColor_Click"
            Style="background-color: #24b6cf; border-color: #24b6cf; color: white; font-size: 15px; margin-right: 10px;">
            Add Product Color <i class="fas fa-plus-circle" style="margin-left: 10px;"></i>
        </asp:LinkButton>

        <asp:LinkButton runat="server" ID="AddProductModel" CssClass="btn" OnClick="AddProductModel_Click"
            Style="background-color: #24b6cf; border-color: #24b6cf; color: white; font-size: 15px; margin-right: 10px;">
            Add Product Model <i class="fas fa-plus-circle" style="margin-left: 10px;"></i>
        </asp:LinkButton>

        <asp:LinkButton runat="server" ID="AddPhoneType" CssClass="btn" OnClick="AddPhoneType_Click"
            Style="background-color: #24b6cf; border-color: #24b6cf; color: white; font-size: 15px;">
            Add Phone Type <i class="fas fa-plus-circle" style="margin-left: 10px;"></i>
        </asp:LinkButton>
    </div>
    <div class="card card-info" style="margin-top: 20px">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4-75">
                    <input type="number" class="form-control" id="inputStock" placeholder="Jumlah" runat="server" required="required" min="1" max="99">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10-75">
                    <div class="custom-file">
                        ...
                        <label id="fileNameLabel" class="custom-file-label" for="inputImage">File gambar</label>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            input.addEventListener('change', function () {
                if (input.files && input.files[0]) {
                    ...
                    fileNameLabel.textContent = "File gambar";
                }
            });
        });
    </script>
