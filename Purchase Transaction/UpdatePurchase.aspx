<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdatePurchase.aspx.cs" Inherits="Unipro_Store.Purchase_Transaction.UpdatePurchase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card card-info">
        ...
        <div class="card-body">
            <div class="form-group row">
                <label for="inputSupplier" class="col-sm-1 col-form-label">Supplier</label>
                ...
                <label for="purchaseInvoice" class="col-sm-0-75 col-form-label">Faktur</label>
                <div class="col-sm-2-4">
                    <div class="custom-file">
                        <asp:FileUpload type="file" ID="inputInvoice" runat="server" CssClass="custom-file-input" />
                        <label id="fileNameLabel" class="custom-file-label" for="inputInvoice">Uploaded image</label>
                        <asp:HiddenField ID="hfImageFileName" runat="server" />
                    </div>
                </div>
                <div class="col-sm-0-5"></div>
                <label for="productSearchBar" class="col-sm-1-25 col-form-label">Cari Produk</label>
                <div class="col-sm-3-1" style="position: relative; padding: 0; margin-left: -7px">
                    ...
                    <asp:Repeater ID="rptProducts" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="product-price" data-price='<%# Eval("Harga") %>'>
                                    <div class="input-group">
                                        <span class="input-group-text" style="background-color: transparent; border: none; font-weight: bold">Rp</span>
                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control price-input"
                                            Text='<%# Eval("Harga", "{0:0.##}") %>' TextMode="Number" Step="1" />
                                    </div>
                                </td>
                                <td>
 ...
 <script type="text/javascript">
     $(document).ready(function () {
         ...
         // Event ketika harga beli berubah
         ...
         // Event saat blur pada harga beli
         $(document).on('blur', '.price-input', function () {
             var qty = parseInt($(this).val());

             if (qty < 0 || isNaN(qty)) {
                 $(this).val(0);
             } else if (qty > 99999999) {
                 $(this).val(99999999);
             }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var input = document.getElementById('<%= inputInvoice.ClientID %>');
            ...
            input.addEventListener('change', function () {
                if (input.files && input.files[0]) {
                    ...
                    fileNameLabel.textContent = "Uploaded invoice";
                }
            });
        });
    </script>
