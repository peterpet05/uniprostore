<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductColor.aspx.cs" Inherits="Unipro_Store.Product_Color.ProductColor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-between" style="margin-bottom:20px">
            <asp:LinkButton runat="server" ID="create" OnClick="create_Click" CssClass="btn btn-primary" 
                ...
                Add New Product Color<i class="fas fa-plus-circle" style="margin-left:10px"></i>
            </asp:LinkButton>
                ...
                <div class="row mb-3 align-items-center">
                    <div class="col-md-12 d-flex align-items-center">
                        <div class="input-group">
                            <input type="search" id="searchKeyword" class="form-control search-with-icon" placeholder="Search keyword" aria-controls="tabelProductColor">
                        </div>
                    </div>
                </div>

                <!-- Tabel Product Color -->
                <table id="tabelProductColor" class="table table-bordered table-striped" style="width: 100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Warna</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="border-radius: 20px; padding: 20px;">
                            ...
                            <div class="modal-body" style="padding-top: 0px;">
                                <p style="font-size: 17px; margin-bottom: 0px">Data warna produk yang telah dihapus tidak dapat dipulihkan kembali.</p>
                                <asp:HiddenField ID="hfProductColorIDToDelete" runat="server" />
                            </div>
    ...
    <script>
        $(document).ready(function () {
            var table = $('#tabelProductColor').DataTable({
                "responsive": true,
                "lengthChange": false,
                "autoWidth": false,
                "dom": 'rt' +
    ...
    <!-- Modal Delete Product Color -->
    <script>
        function showDeleteModal(productColorId) {
            $('#<%= hfProductColorIDToDelete.ClientID %>').val(productColorId);
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("downloadPdf").addEventListener("click", function (event) {
                ...
                if ($.fn.dataTable.isDataTable('#tabelProductColor')) {
                    $('#tabelProductColor').DataTable().page.len(-1).draw();
                }
                ...
                getBase64ImageFromURL('/Admin LTE/dist/img/Head.png', function (headerBase64) {
                    ...
                    doc.setFontSize(15);
                    doc.text('REKAPITULASI DATA WARNA PRODUK', 148.5, 54, { align: 'center' });

                    doc.setFont('helvetica', 'normal');
                    doc.setFontSize(10);
                    doc.text(`Diunduh pada: ${getCurrentDate()}`, 148.5, 61, { align: 'center' });

                    const table = document.getElementById('tabelProductColor');
