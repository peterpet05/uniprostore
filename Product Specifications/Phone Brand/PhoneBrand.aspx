<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PhoneBrand.aspx.cs" Inherits="Unipro_Store.Phone_Brand.PhoneBrand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-between" style="margin-bottom:20px">
            <asp:LinkButton runat="server" ID="create" OnClick="create_Click" CssClass="btn btn-primary" 
                ...
                Add New Phone Brand<i class="fas fa-plus-circle" style="margin-left:10px"></i>
            </asp:LinkButton>
                ...
                <div class="row mb-3 align-items-center">
                    <div class="col-md-12 d-flex align-items-center">
                        <div class="input-group">
                            <input type="search" id="searchKeyword" class="form-control search-with-icon" placeholder="Search keyword" aria-controls="tabelPhoneBrand">
                        </div>
                    </div>
                </div>

                <!-- Tabel Phone Brand -->
                <table id="tabelPhoneBrand" class="table table-bordered table-striped" style="width: 100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Brand</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content" style="border-radius: 20px; padding: 20px;">
                            ...
                            <div class="modal-body" style="padding-top: 0px;">
                                <p style="font-size: 17px; margin-bottom: 0px">Data merek ponsel yang telah dihapus tidak dapat dipulihkan kembali.</p>
                                <asp:HiddenField ID="hfPhoneBrandIDToDelete" runat="server" />
                            </div>
    ...
    <script>
        $(document).ready(function () {
            var table = $('#tabelPhoneBrand').DataTable({
                "responsive": true,
                "lengthChange": false,
                "autoWidth": false,
                "dom": 'rt' +
    ...
    <!-- Modal Delete Phone Brand -->
    <script>
        function showDeleteModal(phoneBrandId) {
            $('#<%= hfPhoneBrandIDToDelete.ClientID %>').val(phoneBrandId);
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("downloadPdf").addEventListener("click", function (event) {
                ...
                if ($.fn.dataTable.isDataTable('#tabelPhoneBrand')) {
                    $('#tabelPhoneBrand').DataTable().page.len(-1).draw();
                }
                ...
                getBase64ImageFromURL('/Admin LTE/dist/img/Head.png', function (headerBase64) {
                    ...
                    doc.setFontSize(15);
                    doc.text('REKAPITULASI DATA MEREK PONSEL', 148.5, 54, { align: 'center' });

                    doc.setFont('helvetica', 'normal');
                    doc.setFontSize(10);
                    doc.text(`Diunduh pada: ${getCurrentDate()}`, 148.5, 61, { align: 'center' });

                    const table = document.getElementById('tabelPhoneBrand');
