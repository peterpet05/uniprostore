    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("downloadPdf").addEventListener("click", function (event) {
                ...
                if ($.fn.dataTable.isDataTable('#tabelProductBrand')) {
                    $('#tabelProductBrand').DataTable().page.len(-1).draw();
                }
                ...
                getBase64ImageFromURL('/Admin LTE/dist/img/Head.png', function (headerBase64) {
                    ...
                    doc.setFontSize(15);
                    doc.text('REKAPITULASI DATA MEREK PRODUK', 148.5, 54, { align: 'center' });

                    doc.setFont('helvetica', 'normal');
                    doc.setFontSize(10);
                    doc.text(`Diunduh pada: ${getCurrentDate()}`, 148.5, 61, { align: 'center' });

                    const table = document.getElementById('tabelProductBrand');
